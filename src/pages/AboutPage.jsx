  ...
  return (
    <DayContainer>
      ...
      <div className='w-full md:w-1/2 mx-auto flex flex-col text-center pb-3'>
        <FormSubHeader sizeClass='subheader-lg'  title={'The calculators'} />
        <p>
        ...
        <FormSubHeader sizeClass='subheader-lg' title={'The data'} />
        <p>
        ...
        <FormSubHeader sizeClass='subheader-lg'  title={'The website'} />
        <p>
